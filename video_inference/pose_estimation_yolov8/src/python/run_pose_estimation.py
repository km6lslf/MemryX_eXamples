...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', '--dfp', type=str, default="models/yolov8m-pose.dfp", help="Specify the path to the compiled DFP file. Default is '../../assets/yolov8m-pose.dfp'.")
    parser.add_argument('-post', '--post_model', type=str, default="models/model_0_yolov8m-pose_post.onnx", help="Specify the path to the post model. Default is '../../assets/model_0_yolov8m-pose_post.onnx.")
